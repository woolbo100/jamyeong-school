  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] text-[#20242A] selection:bg-[#14253D] selection:text-[#FAF9F6]">
      ...
      <main className="max-w-[1200px] mx-auto px-5 sm:px-8">
        {/* =========================================================================
            HERO 영역 (좌우 2단 에디토리얼 레이아웃)
        ========================================================================= */}
        <section className="pt-16 pb-20 sm:pt-24 sm:pb-28 border-b border-[#E7E5DF]">
        ...
        {/* =========================================================================
            01 — ASSOCIATION (협회 소개 영역)
        ========================================================================= */}
        <section id="about" className="py-24 sm:py-32 border-b border-[#E7E5DF] scroll-mt-18">
          {/* 섹션 번호 및 국문 타이틀 */}
          <div className="mb-12">
          ...
          {/* 4대 주요 활동: 둥근 카드 배제 -> 4열 에디토리얼 리스트 */}
        ...
        {/* =========================================================================
            02 — CERTIFICATIONS (등록 민간자격 영역)
        ========================================================================= */}
        <section id="qualifications" className="py-24 sm:py-32 border-b border-[#E7E5DF] scroll-mt-18">
          ...
          {/* 4개 자격증: 2x2 에디토리얼 그리드 (상하 얇은 구분선과 호버 미세 반응) */}
          <div className="grid grid-cols-1 md:grid-cols-2 border-t border-[#D5D3CC]">
            {QUALIFICATIONS_DATA.map((qual, idx) => (
              <div
                key={qual.id}
                className={`p-7 sm:p-9 border-b border-[#D5D3CC] ${
                  idx % 2 === 0 ? "md:border-r border-[#D5D3CC]" : ""
                } hover:bg-white transition-colors group flex flex-col justify-between`}
              >
                ...
                <div className="pt-6 mt-6 border-t border-[#E7E5DF] flex items-center justify-between text-xs">
          ...
          {/* 공통 기준 한 줄 공지 (절제된 공식 안내) */}
          <div className="mt-8 py-4 px-5 bg-white border border-[#E7E5DF] flex flex-col sm:flex-row items-start sm:items-center justify-between text-xs text-[#6B7280] gap-2">
            <span>
        ...
        {/* =========================================================================
            03 — PROCESS (자격 취득 절차: 가로 타임라인 레이아웃)
        ========================================================================= */}
        <section id="process" className="py-24 sm:py-32 border-b border-[#E7E5DF] scroll-mt-18">
          <div className="mb-14">
            <span className="text-xs font-mono tracking-[0.2em] text-[#B59A68] uppercase font-semibold block mb-2">
              03 — PROCESS
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-4 relative">
            {CERT_PROCESS_STEPS.map((step, idx) => (
              <div key={idx} className="relative pt-6 border-t-2 border-[#14253D]/20 space-y-2">
                <span className="text-xs font-mono font-bold text-[#B59A68] block">
                  {step.step}
                </span>
        ...
        {/* =========================================================================
            자격 관리 안내 (에디토리얼 공식 규정 문서 레이아웃)
        ========================================================================= */}
        <section id="management" className="py-20 sm:py-24 border-b border-[#E7E5DF] scroll-mt-18">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
            ...
            {/* 우측: 4가지 관리 기준 번호 리스트 */}
            <div className="lg:col-span-8 bg-white border border-[#D5D3CC] p-6 sm:p-8 space-y-4">
              <span className="text-xs font-bold text-[#14253D] block">
                다음과 같은 경우 자격을 취소하거나 자격증 사용을 제한할 수 있습니다.
              </span>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-[#4B5563] pt-2">
                <div className="p-3.5 bg-[#FAF9F6] border-l-2 border-[#14253D] space-y-1">
        ...
        {/* =========================================================================
            교육과정 안내 (에디토리얼 CTA 구조)
        ========================================================================= */}
        <section className="py-16 sm:py-20 border-b border-[#E7E5DF]">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white border border-[#D5D3CC] p-7 sm:p-10">
        ...
        {/* =========================================================================
            04 — OFFICIAL INFORMATION (협회 공식 정보 & 직인 인증)
        ========================================================================= */}
        <section id="info" className="py-24 sm:py-32 border-b border-[#E7E5DF] scroll-mt-18">
          <div className="mb-12">
            <span className="text-xs font-mono tracking-[0.2em] text-[#B59A68] uppercase font-semibold block mb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
            ...
            {/* 우측 약 35% 공식 직인 인증서 프레임 (절제된 한지/증명서 질감) */}
            <div className="lg:col-span-4 bg-white border border-[#D5D3CC] p-7 space-y-5">
              ...
              <p className="text-[11px] text-[#6B7280] leading-relaxed pt-3 border-t border-[#E7E5DF] text-center">
        ...
        {/* =========================================================================
            민간자격 안내 (단정한 공식 법령 고지)
        ========================================================================= */}
        <section className="py-12 text-center text-xs text-[#6B7280] space-y-1.5">
